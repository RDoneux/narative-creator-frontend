...
describe('ApiService', () => {
  ...
  beforeEach(() => {
    httpMock = jasmine.createSpyObj('HttpClient', ['get', 'post', 'delete', 'patch']);
  ...
  describe('post', () => {
    it('should return http.post with same url', () => {
      ...
      expect(httpMock.post).toHaveBeenCalledOnceWith(mockURL, formData, {headers:{}})
    })
    ...
    it('should return http.post with same url, data and options', () => {
      ...
      expect(postSpy.calls.any()).withContext(mockURL);
      expect(httpMock.post).toHaveBeenCalledOnceWith(mockURL, formData, expectedOptionsOutput)
    })
  })
  describe('delete', () => {
    it('should return http.delete with same url', () => {
      ...
      expect(httpMock.delete).toHaveBeenCalledOnceWith(mockURL, {headers: {}});
    });
